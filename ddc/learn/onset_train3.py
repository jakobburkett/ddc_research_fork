...
def main(_):
    ...
    model_config = {
        ...
        'cnn_init': tf.uniform_unit_scaling_initializer(factor=1.43, dtype=dtype),  #factor=1.43
        ...
        'dnn_init': tf.uniform_unit_scaling_initializer(factor=1.15, dtype=dtype),   #factor=1.15
